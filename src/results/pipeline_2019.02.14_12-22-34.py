...
# Average CV score on the training set was:-5.753442060094964
exported_pipeline = make_pipeline(
    MinMaxScaler(),
    StackingEstimator(estimator=ExtraTreesRegressor(bootstrap=False, max_depth=4, max_features=0.05, min_samples_leaf=0.055, min_samples_split=0.055, n_estimators=400)),
