...
# Average CV score on the training set was:-6.399553434289166
exported_pipeline = make_pipeline(
    ...
    LGBMRegressor(colsample_bytree=0.8, learning_rate=0.001, max_bin=127, max_depth=4, min_child_weight=10, n_estimators=300, num_leaves=40, objective="mape", reg_alpha=0.05, subsample=0.9, subsample_freq=30, verbosity=-1)
)
