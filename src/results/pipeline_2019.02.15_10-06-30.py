...
# Average CV score on the training set was:-5.002431849079609
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=ExtraTreesRegressor(bootstrap=True, max_depth=4, max_features=0.9500000000000002, min_samples_leaf=0.15500000000000003, min_samples_split=0.055, n_estimators=150)),
    ...
    MinMaxScaler(),
    StackingEstimator(estimator=ExtraTreesRegressor(bootstrap=True, max_depth=5, max_features=0.7500000000000002, min_samples_leaf=0.20500000000000002, min_samples_split=0.255, n_estimators=350)),
