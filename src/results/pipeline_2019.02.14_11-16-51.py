...
# Average CV score on the training set was:-5.8045651609727225
exported_pipeline = make_pipeline(
    ...
    RobustScaler(),
    StackingEstimator(estimator=ExtraTreesRegressor(bootstrap=True, max_depth=6, max_features=0.15000000000000002, min_samples_leaf=0.055, min_samples_split=0.005, n_estimators=100)),
    StackingEstimator(estimator=ExtraTreesRegressor(bootstrap=True, max_depth=7, max_features=0.15000000000000002, min_samples_leaf=0.255, min_samples_split=0.055, n_estimators=100)),
    MinMaxScaler(),
