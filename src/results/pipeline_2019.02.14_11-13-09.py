...
# Average CV score on the training set was:-5.841081583821926
exported_pipeline = make_pipeline(
    ...
    StackingEstimator(estimator=ExtraTreesRegressor(bootstrap=True, max_depth=9, max_features=0.6500000000000001, min_samples_leaf=0.255, min_samples_split=0.055, n_estimators=100)),
