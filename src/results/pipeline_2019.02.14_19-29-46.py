...
# Average CV score on the training set was:-5.169906800458116
exported_pipeline = make_pipeline(
    ...
    StackingEstimator(estimator=ExtraTreesRegressor(bootstrap=False, max_depth=8, max_features=0.7500000000000002, min_samples_leaf=0.055, min_samples_split=0.20500000000000002, n_estimators=500)),
