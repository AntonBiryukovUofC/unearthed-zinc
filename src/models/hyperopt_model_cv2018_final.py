...
feature_subset_df = pd.read_csv(f'{project_dir}/notebooks/shap-importance-final-diff_deriv_normalized_with_interaction.csv')
X_sub = X.copy()
...
for N in n_array:
    ...
    fpath = f'{project_dir}/models/{N}_feats_final_Trials.pkl'
    fpath_csv = f'{project_dir}/models/{N}_feats_final_Trials.csv'
