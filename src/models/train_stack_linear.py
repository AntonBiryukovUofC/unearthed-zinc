...
from sklearn.linear_model import LassoCV,RidgeCV,BayesianRidge,ElasticNetCV
...
N_lvl_dicts = {}
# Gather models first:
n_array = np.arange(start=50, stop=feature_subset_rougher_df.shape[0], step=100, dtype='int')
...
fpath_test = f'{project_dir}/models/test_features_rougher_linear.pkl'
fpath_train = f'{project_dir}/models/train_features_rougher_linear.pkl'
